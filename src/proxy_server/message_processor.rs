...
use rand::Rng;
use std::net::IpAddr;
use trust_dns_proto::op::{OpCode, ResponseCode};
...
pub struct ForwardedRequest {
    pub original_request_header: trust_dns_proto::op::Header,
...
struct AllowedDomain {
    domain_name: trust_dns_proto::rr::Name,
...
impl DnsMessageProcessor {
    ...
    pub fn process_client_request(
        ...
        // Parse request
        let request = match trust_dns_proto::op::Message::from_vec(buffer) {
            Ok(request) => request,
            Err(e) => {
    ...
    pub async fn process_upstream_response(
        ...
        // Parse response
        let response = match trust_dns_proto::op::Message::from_vec(buffer) {
    ...
    pub fn build_response(
        request: &trust_dns_proto::op::Header,
        rcode: trust_dns_proto::op::ResponseCode,
        ...
        into_buffer.clear(); // trust_dns_proto's encoder assumes the buffer to be empty, otherwise, internal assertions will fail!
        let mut encoder = trust_dns_proto::serialize::binary::BinEncoder::new(into_buffer);
    ...
    fn build_response_with_static_ip(
        &self,
        client_address: IpAddr,
        mut request: trust_dns_proto::op::Message,
        answers: impl Iterator<Item = (trust_dns_proto::rr::Name, IpAddr)>,
        into_buffer: &mut Vec<u8>,
    ) {
        let mut response = trust_dns_proto::op::Message::new();
...
impl ForwardedRequest {
    ...
    fn find_allowed_domains_with_cnames(
        &self,
        response: &trust_dns_proto::op::Message,
        domain_name: trust_dns_proto::rr::Name,
    ) -> Vec<AllowedDomain> {
